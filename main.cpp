...
//solely by me, Esther Tsai, and that any help I received
//adhered to the rules for this exam.
#include <iostream>
#include "Movie.h"
#include "Theater.h"
using namespace std;
...
int main()
{
	...
	if (garland.getShowtimeForGenre("Romance") != -1)
	{
		cout << garland.getShowtimeForGenre("Romance");
	}
